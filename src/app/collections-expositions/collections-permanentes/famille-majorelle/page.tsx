  ...
  const collectionImages = [
    {
      ...
      alt: 'Illustration artistique d\'un village marocain',
      title: 'Paysage marocain',
      description: 'Cette œuvre représente un village traditionnel marocain avec son architecture caractéristique en terre ocre, entouré de paysages verdoyants.',
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <motion.div 
              ...
              className="mb-16"
            >
              <h2 className="font-bodoni text-3xl md:text-4xl mb-8 text-center">L'héritage artistique des Majorelle</h2>
              <div className="max-w-3xl mx-auto">
                <p className="text-gray-800 text-lg leading-relaxed mb-6">
                  La famille Majorelle a profondément marqué l'histoire de l'art et de l'artisanat au Maroc. Jacques Majorelle, peintre orientaliste français, est particulièrement connu pour ses représentations vibrantes des paysages et de la vie marocaine, ainsi que pour la création du célèbre Jardin Majorelle à Marrakech.
                </p>
                <p className="text-gray-800 text-lg leading-relaxed">
                  Cette collection présente des œuvres illustrant le regard unique que la famille Majorelle a porté sur le Maroc, capturant l'essence de ses paysages, de son architecture et de sa culture avec une sensibilité artistique exceptionnelle.
                </p>
              </div>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12">
              {collectionImages.map((image) => (
                ...
                >
                  <div 
                    className="relative aspect-[4/3] cursor-pointer overflow-hidden bg-gray-100 rounded-lg shadow-lg"
                ...
                {currentImageData && (
                  <div className="w-1/3 p-6 md:p-8 text-gray-800 border-l border-gray-200 flex flex-col justify-center">
                    ...
                    <div className="space-y-4">
                      <div>
                        <h4 className="text-xs md:text-sm uppercase tracking-wider text-gray-500 mb-1">Artiste</h4>
                        <p className="font-medium text-sm md:text-base">{currentImageData.artist}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        <h4 className="text-xs md:text-sm uppercase tracking-wider text-gray-500 mb-1">Technique</h4>
                        <p className="font-medium text-sm md:text-base">{currentImageData.technique}</p>
                      </div>
                    </div>
                  </div>
                )}
...
export default FamilleMajorellePage; 
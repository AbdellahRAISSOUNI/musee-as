...
const LaCeramiqueDeFesPage = () => {
  ...
  const collectionImages = [
    {
      id: 1,
      src: '/images/collections-permanentes/la-ceramique-de-fes/bol_1.jpg',
      alt: 'Bol en céramique de Fès',
      title: 'Bol',
    ...
    {
      id: 2,
      src: '/images/collections-permanentes/la-ceramique-de-fes/jarre.jpg',
      alt: 'Khabiya (jarre) en céramique de Fès',
      title: 'Khabiya (jarre)',
      description: 'Cette grande jarre avec couvercle sert à la conservation de la viande. Le motif plus libre de la panse suggère un mouvement comparable à des vagues déferlant sur la plage. Des fleurs et l\'évocation de coeurs agrémentent les autres parties de la jarre.',
      material: 'Céramique émaillée',
      period: 'XXe siècle',
      origin: 'Fès, Maroc'
    }
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <motion.div 
              ...
              className="mb-16"
            >
              <h2 className="font-bodoni text-3xl md:text-4xl mb-8 text-center">L'art de la céramique fassi</h2>
              <div className="max-w-3xl mx-auto">
                <p className="text-gray-800 text-lg leading-relaxed mb-6">
                  La céramique de Fès constitue l'un des fleurons de l'artisanat marocain. Reconnue pour ses motifs géométriques complexes et ses couleurs vives dominées par le bleu de cobalt, cette tradition séculaire témoigne d'un savoir-faire transmis de génération en génération.
                </p>
                <p className="text-gray-800 text-lg leading-relaxed">
                  Les pièces présentées dans cette collection illustrent la diversité et la richesse des formes et des usages de la céramique dans la vie quotidienne marocaine traditionnelle, ainsi que l'excellence technique des artisans de Fès.
                </p>
              </div>
            </motion.div>
...
export default LaCeramiqueDeFesPage; 
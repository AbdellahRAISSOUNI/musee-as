      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            ...
            >
              <p>
                Casa Drawing est une exposition collective qui met en lumière la richesse et la diversité du dessin contemporain au Maroc. Cette exposition rassemble des œuvres d'artistes marocains et internationaux qui explorent différentes techniques et approches du dessin.
              </p>
              <p>
                L'exposition présente une sélection d'œuvres qui témoignent de la vitalité de la scène artistique casablancaise et de son rayonnement international. Du dessin académique aux expérimentations contemporaines, Casa Drawing offre un panorama complet de cet art fondamental.
              </p>
              <p>
                Cette manifestation artistique s'inscrit dans la volonté du Musée de la Fondation Abderrahman Slaoui de promouvoir l'art contemporain marocain et de créer des ponts entre les différentes générations d'artistes.
              </p>
            </motion.div>

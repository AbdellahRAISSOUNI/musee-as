    ...
    <main className="min-h-screen bg-white text-gray-800">
      ...
      <section className="container mx-auto px-6 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2 className="font-bodoni-regular text-3xl text-gray-900 mb-6 text-center">
              Notre Mission
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              <div className="text-center">
                ...
                <h3 className="font-bodoni-regular text-xl text-gray-900 mb-2">Préserver</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-bodoni-regular text-xl text-gray-900 mb-2">Exposer</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-bodoni-regular text-xl text-gray-900 mb-2">Éduquer</h3>
          ...
          >
            <div className="bg-white border border-gray-200 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <h2 className="font-bodoni-regular text-2xl mb-4 text-gray-900">Le Projet de Musée</h2>
              ...
              <Link 
                ...
                className="inline-block text-accent-gold hover:text-accent-gold/80 transition-colors font-bodoni-regular border-b border-accent-gold pb-1"
              >
                En savoir plus
              </Link>
            </div>
            ...
            <div className="bg-white border border-gray-200 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <h2 className="font-bodoni-regular text-2xl mb-4 text-gray-900">Ils Parlent de Nous</h2>
              <p className="text-gray-700 mb-4">
